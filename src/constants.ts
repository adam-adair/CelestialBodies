const gravitationalFactor = 1; // we would only change this if we wanted to rescale planet masses to smaller units. but doing so screws up the accelerations so let's not.
